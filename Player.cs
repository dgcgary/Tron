...
namespace Tron
{
    ...
    public class Player
    {
        /// Nodo que representa la cabeza del jugador.
        public Nodo Cabeza { get; private set; }

        /// Cantidad de combustible actual del jugador.
        public double Combustible { get; set; }

        
        /// Cantidad máxima de combustible que el jugador puede tener.
        ...
        /// Indica si el jugador está en hipervelocidad.
        ...
        /// Pila de PowerUps que el jugador ha recogido.
